...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.deleteSourceEstContainersStmt, err = db.PrepareContext(ctx, deleteSourceEstContainers); err != nil {
		return nil, fmt.Errorf("error preparing query DeleteSourceEstContainers: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.deleteSourceEstContainersStmt != nil {
		if cerr := q.deleteSourceEstContainersStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing deleteSourceEstContainersStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	deleteSourceEstContainersStmt      *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		deleteSourceEstContainersStmt:      q.deleteSourceEstContainersStmt,
